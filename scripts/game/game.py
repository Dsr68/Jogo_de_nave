...
class Game(Scene): 
    ...
    def __init__(self):
        ...
        self.bg = AnimacaoBG("assets/menu/bg.png", [0,0], [0, -720], [self.all_sprites])
        self.spaceship = SpaceShip([600,600],[self.all_sprites])
...
class SpaceShip(Obj):
    ...
    def update(self):
        ...
        self.limit()
        self.move()
        self.animation_para_frente(8, 2, "assets/nave1/nave10", self.frame)
        self.animation_para_esquerda(8, 2, "assets/nave1/nave10", self.frame)
        self.animation_para_direita(8, 2, "assets/nave1/nave10", self.frame)
